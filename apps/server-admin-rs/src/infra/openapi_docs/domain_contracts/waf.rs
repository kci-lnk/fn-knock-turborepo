...
pub(super) struct WafConfigData {
    ...
    violation_rate_limit_enabled: bool,
    #[schema(minimum = 1, maximum = 10000)]
    violation_rate_limit_capacity: i64,
    #[schema(minimum = 1, maximum = 86400)]
    violation_rate_limit_refill_seconds: i64,
...
pub(super) struct WafConfigUpdateData {
    ...
    violation_rate_limit_enabled: Option<bool>,
    #[schema(minimum = 1, maximum = 10000)]
    violation_rate_limit_capacity: Option<i64>,
    #[schema(minimum = 1, maximum = 86400)]
    violation_rate_limit_refill_seconds: Option<i64>,
