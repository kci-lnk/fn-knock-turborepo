export const ROUTE_TYPE_TRANSLATION_KEYS = {
  ...
  static_file: "admin.wafLogs.routeTypes.staticFile",
  static_directory: "admin.wafLogs.routeTypes.staticDirectory",
  toolbar_asset: "admin.wafLogs.routeTypes.toolbarAsset",
  toolbar_data: "admin.wafLogs.routeTypes.toolbarData",
