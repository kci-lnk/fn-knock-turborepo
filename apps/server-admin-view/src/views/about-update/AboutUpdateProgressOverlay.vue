...
<template>
  <!-- Keep viewport positioning independent of the tabs' transform animation. -->
  <Teleport to="body">
    <div
      v-if="isUpdateModalVisible"
      class="fixed inset-0 z-[120] flex items-center justify-center bg-background/80 p-4 backdrop-blur-md transition-all duration-300"
    >
      <div
        class="flex max-h-full w-full max-w-sm flex-col items-center space-y-6 overflow-y-auto rounded-2xl border border-border/50 bg-background/95 p-8 text-center shadow-2xl"
      >
        <div
