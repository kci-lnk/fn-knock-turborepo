...
export const useHostTrafficStats = (options: {
  active: Readonly<Ref<boolean>>;
  host: Readonly<Ref<string>>;
  sample: Readonly<Ref<HostTrafficStats | null>>;
  ...
  watch(
    () => [options.active.value, rangeKey.value, options.host.value] as const,
    ([active]) => {
