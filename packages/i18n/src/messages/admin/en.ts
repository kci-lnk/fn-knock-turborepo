export const enAdmin = {
  webTerminalSettings: {
    description: "Manage Web Terminal availability.",
  ...
  maintenanceSettings: {
    emailStateEnabled: "Enabled",
    emailStateDisabled: "Disabled",
    emailEntryDescription: "Configure the sender, recipients and backup attachment delivery",
    emailBack: "Back to backup and maintenance",
    emailReload: "Reload",
    emailBackupDisabled: "Automatic backup is disabled. You can save email settings now; delivery starts after enabling automatic backup.",
    emailDeliveryStatus: "Delivery status",
    emailStatusDescription: "Review email delivery results and retries separately.",
    emailSave: "Save email settings",
    emailConnection: "Connection and authentication",
    emailAddresses: "Sender and recipients",
    emailLimits: "Delivery limits and testing",

    emailErrorConnection: "SMTP server is unavailable.",
    emailErrorRejected: "SMTP server rejected the email; check authentication, recipients and server limits.",
    emailErrorTimeout: "SMTP request timed out.",
    emailErrorAttachment: "Backup exceeds the attachment limit; the file remains local.",
    emailErrorFile: "The backup file is missing or cannot be read safely.",
    emailErrorExpired: "Delivery expired or reached the retry limit.",
    emailErrorCredentials: "Saved SMTP credentials are unavailable.",
    emailErrorInvalid: "Email configuration is invalid.",

    emailTitle: "Backup email",
    emailEnabled: "Enable email delivery",
    emailDescription: "Send the backup as an attachment. Email settings are independent of notifications; failed delivery is retried automatically.",
    email_host: "SMTP host",
    email_username: "SMTP username",
    emailSecurity: "Connection security",
    emailNoTls: "No TLS",
    emailPort: "SMTP port",
    emailAuth: "Authentication",
    emailAuto: "Automatic",
    emailNoAuth: "No authentication",
    emailPassword: "SMTP password",
    emailPasswordSaved: "Saved; leave blank to keep",
    emailClearPassword: "Clear saved password",
    emailFrom: "Sender address",
    emailName: "Instance / sender name",
    emailTo: "Recipients (comma-separated)",
    emailTimeout: "Timeout (seconds)",
    emailLimit: "Attachment limit (MiB)",
    emailTest: "Send test email",
    emailTesting: "Sending…",
    emailTestSuccess: "Test email sent. Check the attachment.",
    emailTestFailed: "Test failed. Check SMTP settings, credentials and recipients.",
    emailLastAttempt: "Last delivery attempt",
    emailLastSuccess: "Last successful delivery",
    emailPending: "Pending emails",
    emailNextRetry: "Next retry",
    emailDeliveryFailed: "Delivery failed (local backup retained)",
    ...
    title: "Maintenance",
    description:
      "Export or restore system backups, including saved Web Terminal and Wake-on-LAN passwords, private keys, and key passphrases.",
    importWarning:
  ...
  mappingManagement: {
    ...
    description: "Manage subdomain and protocol mappings in one place.",
    subdomainTab: "Subdomains",
    protocolTab: "Protocols",
  },
  streamMappings: {
  ...
  subdomainProxy: {
    ...
    staticServe: {
      ...
      browser: {
        ...
        open: "Browse",
        hint: "Browse files and folders visible to the gateway process. Choosing a path does not expose it until you save the mapping.",
        dockerHint:
        ...
        loading: "Loading server paths...",
        retry: "Try again",
        empty: "This folder has no visible entries.",
        name: "Name",
        size: "Size",
        modified: "Modified",
        previousPage: "Previous",
        nextPage: "Next",
        openDirectoryAria: "Open folder {name}",
        selectFileAria: "Select file {name}",
        selectedPath: "Path to use:",
        noSelection: "No selectable path",
        cancel: "Back to mapping",
        useCurrentFolder: "Use current folder",
        useSelectedFile: "Use selected file",
        errors: {
          invalid_path: "The requested path is invalid.",
          invalid_cursor:
            "This page is no longer valid. Open the folder again.",
          protected_path: "This protected location cannot be browsed.",
          not_found: "The requested path no longer exists.",
          permission_denied: "FN-Knock cannot read this location.",
          not_directory: "The requested location is not a folder.",
          directory_too_large:
            "This folder has too many entries to browse safely.",
          unsupported_type: "This location type is not supported.",
          unavailable: "Path browsing is unavailable in this runtime.",
          browse_failed: "Could not browse server paths. Try again.",
          invalid_response: "The gateway returned an invalid path listing.",
        },
      },
    ...
    batchEdit: {
      ...
      titleHint: "Leave empty to use the automatic title. Other settings are preserved.",
      target: "Target URL",
      path: "File / directory path",
      save: "Save all",
      saving: "Saving…",
      retry: "Retry related settings",
      saved: "All mapping changes saved",
      invalidHost: "Enter a valid full domain.",
      duplicateHost: "Domain is duplicated or already in use. Existing domains cannot be swapped.",
      invalidTarget: "Enter a valid HTTP, HTTPS, WS or WSS target URL.",
      authTarget: "Batch editing cannot turn an application mapping into an authentication service.",
      invalidPath: "Enter a safe absolute server path and check the existing static serving settings.",
      conflict: "Configuration changed. Keep a copy of your edits and reopen batch editing to avoid overwriting other changes.",
      failed: "Save failed. Please retry.",
      partial: "Mappings saved, but some related settings could not be updated. Retry related settings.",
      discardTitle: "Close batch editing?",
      discardDescription: "Unsaved changes will be discarded when you close this dialog.",
      partialDiscard: "Mappings are saved, but related settings are incomplete. Closing will not undo saved changes; check related settings in the individual editor afterwards.",
    ...
    batchDeleteTitle: "Delete {count} subdomains?",
    batchDeleteDescription:
      "The selected Host mappings will be permanently deleted. This cannot be undone.",
    confirmBatchEnable: "Enable {count}",
    confirmBatchDisable: "Disable {count}",
    confirmBatchDelete: "Delete {count}",
    batchMappingsEnabled: "Enabled {count} subdomains",
    ...
    batchAvailabilitySaved: "Schedule saved for {count} subdomains",
    batchAvailabilityCleared: "Schedule cleared for {count} subdomains",
    ...
    mappingDialogTitle: "Mapping configuration",
    mappingDialogDescription:
      "Configure a subdomain mapping, its target, and its access behavior.",
  ...
  webTerminal: {
    metrics: {
      ...
      loading: "Sampling…",
      failed: "Metrics unavailable",
      stale: "Metrics out of date",
      rootFilesystem: "Filesystem mounted at /, not total disk capacity",
      reason: {
        warming_up: "Waiting for the next CPU sample",
        unsupported_platform: "This metric is not supported on this system",
        missing_command: "Required system command is unavailable",
        permission_denied: "Cannot read system counters",
        invalid_output: "System output could not be parsed",
        counter_reset: "CPU counters reset; waiting for a new sample",
        estimated: "Estimated from available system counters",
        exec_rejected: "The SSH server rejected the metrics channel",
        timeout: "Sampling timed out",
        output_limit: "Sampling output exceeded the limit",
        collection_failed: "System data could not be collected",
        session_inactive: "The terminal session is not running",
      },
    },
    title: "Web terminal",
    destroyDescription:
    ...
    sessionPhase: {
      ...
      requestingPty: "Requesting terminal PTY",
      running: "Running",
      closing: "Closing",
      closed: "Closed",
      exited: "Shell exited",
    ...
    clearPassphrase: "Clear private-key passphrase",
    hostIdentity: "Host identity",
    confirmHostKey: "Confirm host fingerprint",
    trustAndTestHostKey: "Confirm and test SSH",
    hostKeyTrusted: "Fingerprint trusted",
    connectionTested: "Connection tested",
    terminateSessionsOnSave:
      "End {count} active session(s) if this connection change requires it.",
    terminateSessionsOnSaveUnknown:
      "End all active sessions and apply this connection change.",
    activeSessionsAffected: "Active sessions will be affected",
    deleteTargetTitle: "Delete SSH target?",
    deleteTargetDescription:
      "The saved target and its encrypted credential will be removed.",
    deleteTargetActiveDescription:
      "Deleting this target will end {count} active session(s).",
    targetDeleted: "SSH target deleted",
    targetDeleteFailed: "Could not delete SSH target",
    forceDeleteTargetTitle: "End sessions and delete target?",
    forceDeleteTargetDescription:
      'SSH target "{target}" still has active sessions. This second confirmation will end them before deleting the target.',
    forceDeleteSessionCount: "{count} active session(s) will be ended.",
  ...
  wafLogs: {
    ...
    routeTypes: {
      ...
      certificateDeploy: "Certificate deployment",
      select: "Select page",
      wol: "Wake-on-LAN",
      preflight: "Preflight",
  ...
  requestAnalysis: {
    ...
    description:
      "Review request logs, WAF events, and traffic analytics in one place.",
  ...
  gatewayRequestLogs: {
    ipView: {
      viewLabel: "View",
      individual: "Individual requests",
      grouped: "By IP",
      hint: "One row per IP, covering all saved requests matching the selected date and filters.",
      sortLabel: "Sort by",
      requests: "Requests",
      hosts: "Sites",
      responses: "Responses",
      ...
      last: "Latest",
      open: "View requests",
      back: "Back to IP list",
      unknown: "Unknown source",
      showAll: "All requests from this IP on this day",
      retry: "Retry",
      loading: "Analyzing all requests for the selected day…",
      summary: "{date} · {ips} IPs · {requests} requests",
      filteredSummary: "{date} · Filtered: {ips} IPs · {requests} requests",
      detailCount: "{count} requests matching current filters",
      hostCount: "{count} sites",
      requestCount: "{count} requests",
      page: "Page {page}",
      sorts: {
        requests: "Most requests",
        last_seen: "Latest visit",
        client_errors: "Most 4xx",
        server_errors: "Most 5xx",
        waf_hits: "Most WAF hits",
      },
    },
    title: "Request logs",
    description:
    ...
    authDecisions: {
      ...
      scopeDenied: "Denied by credential scope",
      http1Required: "HTTP/1 required",
      http2Required: "HTTP/2 required",
      disabled: "Host disabled",
      outsideWindow: "Outside availability window",
      scheduleClosed: "Schedule closed",
      advancedBypass: "Allowed by advanced bypass",
      authUnconfigured: "Authentication not configured",
      authError: "Authentication service error",
      timeout: "Authentication timed out",
      queueFull: "Authentication queue full",
      disconnected: "Authentication bridge disconnected",
      bridgeUnavailable: "Authentication bridge unavailable",
    ...
    accessModes: {
      ...
      strictWhitelist: "Strict allowlist",
    },
    boolean: {
      yes: "Yes",
      no: "No",
  ...
  eventCenter: {
    ...
    eventTypes: {
      ...
      FN_EVENT_TERMINAL_AUDIT: "Web terminal audit",
    },
    groupBy: {
      GLOBAL: "Global",
      IP: "IP",
    ...
    runtime: {
      ...
      debug: {
        ...
        description:
          "Inspect process resources, threads, background tasks and SQLite activity.",
        unavailable:
          "Runtime diagnostics is unavailable. Check that the frontend and backend versions match.",
        loadFailed:
          "The diagnostic request failed. Displayed data may be stale; retry to update it.",
        retry: "Retry",
        loading: "Loading diagnostics",
        cpus: "{count} logical CPUs",
        updated: "Report retrieved",
        capture: "60-second capture",
        captureWindow: "Capture window",
        remaining: "About {seconds}s remaining",
        samples: "{count} samples",
        stop: "Stop and keep results",
        start: "Start 60-second capture",
        captureHint:
          "Capture starts only when requested, once per second for up to 60 seconds. It finishes even if this window closes. A new capture replaces the previous results.",
        averageCpu: "Average CPU",
        peakCpu: "Peak CPU",
        latestRss: "Latest sample RSS",
        rssChange: "RSS change during capture",
        empty:
          "No samples yet. Start a capture to observe resource and operation activity.",
        cpuHint:
          "CPU uses 100% for one fully occupied logical core. The first sample has no CPU delta. Percentages are not directly comparable across hardware.",
        rssHint:
          "Stable RSS does not rule out leaks; compare longer runs and repeated operations.",
        partial: "Some metrics are unavailable",
        sampleDetails: "Per-second samples",
        time: "Time",
        queue: "Queued",
        memory: "Memory breakdown",
        refreshMemory: "Collect memory details",
        memoryHint:
          "Reads memory mapping statistics on demand without reclaiming memory. This snapshot has its own timestamp, separate from the capture.",
        memoryEmpty: "Memory details have not been collected.",
        snapshotRss: "Snapshot RSS",
        anonymous: "Anonymous memory",
        file: "File mappings",
        swap: "Swap",
        category: "Category",
        mappings: "Mappings",
        allocator: "Allocator statistics",
        allocatorHint:
          "These are allocator accounting figures. Allocated bytes are not an exact live-object size, and not all free space can necessarily be returned to the OS.",
        allocated: "Allocated",
        free: "Allocator free space",
        mapped: "Direct mappings",
        releasable: "Potentially releasable",
        largestRegions: "Largest anonymous regions",
        size: "Virtual size",
        threads: "Thread CPU hotspots",
        threadsHint:
          "Estimated averages from up to 8 thread hotspots per sample, showing the top 8. Activity below each sample’s cutoff may be omitted. Thread names are diagnostic clues.",
        threadsEmpty:
          "No thread samples yet, or thread CPU statistics are unsupported on this system.",
        name: "Thread name",
        operations: "Background tasks and database operations",
        wallHint:
        ...
        rows: "Reported items",
        rowsHint:
          "Item counts include only business items explicitly reported by an operation, not all affected SQL rows. Unfinished means incomplete at the current or final capture snapshot.",
        operationsEmpty:
          "No operations of this type recorded during the capture.",
        dropped:
          "{count} operations exceeded the statistics limit and are not included.",
        queueDepth: "Primary queue: current / lifetime peak",
        queueWait: "Queue wait: latest / lifetime peak",
        activeOperation: "Current operation elapsed",
        privacy:
          "Export contains diagnostic labels and metrics, without SQL, request contents, configuration or credentials.",
        copy: "Copy JSON",
        export: "Export JSON",
        copied: "Runtime diagnostics copied",
        copyFailed: "Copy failed. Use Export JSON instead.",
        status: {
          idle: "Not started",
          running: "Capturing",
          completed: "Completed",
        ...
        categories: {
          heap: "Main heap",
          main_stack: "Main thread stack",
          anonymous_mappings: "Anonymous mappings",
          file_or_special: "File and system mappings",
        },
        memoryStatus: {
          available: "Details available",
          partial: "Partial details",
          unsupported: "Detailed mapping statistics unsupported on this system",
          unavailable: "Unable to read memory details",
        },
      },
      memory: {
    ...
    events: {
      ...
      terminalAuditActions: {
        ...
        target_updated: "SSH target updated",
        target_deleted: "SSH target deleted",
  ...
  notifications: {
    ...
    body: {
      ...
      factVariables: "Notification details",
      commonFacts: "Common details",
      factVariablesHelp:
        "Insert detail variables by event. Values match the notification display. Fields from other events may be absent; preview lists missing variables.",
      mode: "Body mode",
      ...
      variablesHelp:
        "Insert safe path variables with {'{{'}path{'}}'}. In JSON, a string containing only one variable preserves its JSON type; embedded variables become text. Escape a literal opening delimiter with {'\\\\{{'}. Missing values are shown by preview and do not block sending.",
      loadSample: "Insert sample JSON",
      sampleContext: "Sample context",
      sampleHelp:
        "Leave blank to use server sample data. Insert or edit JSON to override the preview and test request only; it is not saved.",
      preview: "Render preview",
      previewing: "Rendering…",
      testing: "Sending…",
      testSend: "Send test",
      missingVariables: "Missing variables",
      previewFailed: "Failed to render webhook body",
      testFailed: "Webhook test send failed",
      testSuccess: "Webhook test sent successfully",
      fixErrors: "Fix the webhook body configuration first",
      errors: {
        invalidMode: "Select a valid body mode.",
        invalidFormat: "Select JSON or text format.",
        templateRequired: "Enter a body template.",
        templateTooLarge: "The template cannot exceed {max} bytes.",
        invalidJson: "The JSON template is invalid: {detail}",
        unclosedVariable: "A template variable is missing its closing braces.",
        invalidVariable: "Template variable {detail} is not allowed.",
        tooManyVariables:
          "The template cannot contain more than {max} variables.",
        invalidContentType: "Enter a valid Content-Type MIME value.",
        contentTypeTooLong: "Content-Type cannot exceed {max} bytes.",
        sampleTooLarge: "The sample context cannot exceed {max} bytes.",
        invalidSample: "The sample context must be a JSON object.",
      },
    },
    deliveries: {
