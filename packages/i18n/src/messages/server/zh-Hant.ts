...
export const zhHantServer = {
  ...
  admin: {
    ...
    runtimeConfigRoutes: {
      ...
      loadWolFeatureFailed: "載入遠端喚醒功能配置失敗",
      saveWolFeatureFailed: "保存遠端喚醒功能配置失敗",
      syncWolFeatureFailed: "同步遠端喚醒功能到網關失敗",
      invalidWolFeature: "遠端喚醒功能配置無效",
    ...
    hostMappings: {
      ...
      targetPathModeInvalid:
        "Host 映射 {host} 的目標路徑模式必須是 entry 或 prefix",
      backendTargetPathModeUnsupported:
        "閘道後端未套用 {host} 的目標路徑模式 {mode}，請升級閘道後端",
  ...
  ldap: {
    ...
    listProvidersFailed: "取得 LDAP 提供商失敗",
    providerPayloadObject: "提供商配置必須是物件",
    createProviderFailed: "建立 LDAP 提供商失敗",
    providerNotFound: "LDAP 提供商不存在",
    loadProviderFailed: "載入 LDAP 提供商失敗",
    updateProviderFailed: "更新 LDAP 提供商失敗",
    deleteProviderFailed: "刪除 LDAP 提供商失敗",
    connectionTestSuccess: "LDAP 連線測試成功",
    testProviderFailed: "LDAP 連線測試失敗",
    testCredentialsRequired: "目錄使用者名稱和密碼必須同時提供",
    listBindingsFailed: "取得 LDAP 綁定失敗",
    bindingNotFound: "LDAP 綁定不存在",
    deleteBindingFailed: "刪除 LDAP 綁定失敗",
    invitationFieldsRequired: "必須選擇 TOTP 憑據和 LDAP 提供商",
    loadTotpFailed: "載入 TOTP 憑據失敗",
    totpMissing: "TOTP 憑據不存在",
    providerUnavailable: "LDAP 提供商不可用",
    loadConfigFailed: "載入配置失敗",
    inviteUrlBuildFailed: "產生 LDAP 邀請連結失敗",
    createInviteFailed: "建立 LDAP 邀請失敗",
    loginMethodUnavailable: "目前登入模式不支援 LDAP 登入",
    inviteInvalid: "LDAP 邀請無效",
    inviteExpired: "LDAP 邀請已過期或已使用",
    serviceUnavailable: "目錄服務暫時不可用",
    invalidCredentialsWithRetry: "目錄憑據無效，請在 {seconds} 秒後重試。",
    invalidCredentials: "目錄憑據無效或帳號尚未綁定",
    bindingConflict: "該目錄身份已綁定，或邀請已被使用",
    bindingFailed: "綁定目錄身份失敗",
    createSessionFailed: "建立登入會話失敗",
    loginSuccessful: "LDAP 登入成功",
  },
  subdomainMode: {
  ...
  maintenanceBackup: {
    ...
    syncSteps: {
      ...
      smartConnect: "智能連接",
      fnosPortIconHijack: "飛牛端口圖標接管",
      fnosNetworkTuning: "飛牛網路調優",
      transactionFinalize: "備份匯入交易收尾",
      locale: "語言配置",
  ...
  notifications: {
    ...
    templates: {
      ...
      terminalActions: {
        targetCreated: "已建立 SSH 目標",
        targetUpdated: "已更新 SSH 目標",
        targetDeleted: "已刪除 SSH 目標",
        hostKeyConfirmed: "已確認主機指紋",
        connectionTestSucceeded: "SSH 連線測試成功",
        connectionTestFailed: "SSH 連線測試失敗",
        localTerminalEnabled: "已啟用本機終端",
        localTerminalDisabled: "已停用本機終端",
        sessionCreationStarted: "已開始建立終端工作階段",
        sessionCreationFailed: "終端工作階段建立失敗",
        sessionEnded: "終端工作階段已結束",
        sessionExited: "Shell 已結束",
        sessionLost: "終端工作階段連線遺失",
      },
      credential: "憑證",
