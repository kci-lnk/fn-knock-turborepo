export const koKRServer = {
  ...
  maintenanceBackup: {
    ...
    syncSteps: {
      ...
      smartConnect: "스마트 연결",
      fnosPortIconHijack: "FNOS 포트 아이콘 인계",
      fnosNetworkTuning: "FNOS 네트워크 튜닝",
      transactionFinalize: "백업 가져오기 트랜잭션 마무리",
      locale: "언어 설정",
    ...
    exportTooLarge: "백업 데이터가 너무 커서 내보낼 수 없습니다.",
  ...
  notifications: {
    ...
    templates: {
      ...
      terminalActions: {
        targetCreated: "SSH 대상 생성",
        targetUpdated: "SSH 대상 업데이트",
        targetDeleted: "SSH 대상 삭제",
        hostKeyConfirmed: "호스트 지문 확인",
        connectionTestSucceeded: "SSH 연결 테스트 성공",
        connectionTestFailed: "SSH 연결 테스트 실패",
        localTerminalEnabled: "로컬 터미널 활성화",
        localTerminalDisabled: "로컬 터미널 비활성화",
        sessionCreationStarted: "터미널 세션 생성 시작",
        sessionCreationFailed: "터미널 세션 생성 실패",
        sessionEnded: "터미널 세션 종료",
        sessionExited: "Shell 종료",
        sessionLost: "터미널 세션 연결 끊김",
      },
      credential: "자격 증명",
      ...
      details: {
        ...
        facts: {
          ...
          terminalAction: "터미널 작업",
          terminalTarget: "SSH 대상",
          terminalSession: "SSH 세션",
          terminalRevision: "대상 리비전",
          errorCode: "오류 코드",
          eventType: "이벤트 유형",
          riskLevel: "위험 수준",
          eventSource: "이벤트 출처",
