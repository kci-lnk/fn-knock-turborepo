  ...
  notifications: {
    ...
    templates: {
      ...
      terminalActions: {
        ...
        sessionCreationStarted: "SSH session creation started",
        sessionCreationFailed: "SSH session creation failed",
        sessionEnded: "SSH session ended",
        sessionExited: "Remote shell exited",
        sessionLost: "SSH session lost",
      },
