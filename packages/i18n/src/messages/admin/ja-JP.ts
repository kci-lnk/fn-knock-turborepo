...
export const jaJPAdmin = {
  webTerminalSettings: {
    description: "Web ターミナルの有効・無効を管理します。",
  ...
  gatewaySettings: {
    http3: {
      ...
      states: {
        running: "ローカルで待ち受け中",
        disabled: "無効",
        suspended_frp: "管理 FRP により一時停止",
        waiting_certificate: "TLS 証明書待ち",
        waiting_bridge: "認証ブリッジ待ち",
        error: "待ち受けエラー",
        unknown: "状態取得不可",
      },
    },
  ...
  maintenanceSettings: {
    emailStateEnabled: "有効",
    emailStateDisabled: "無効",
    emailEntryDescription: "送信者、宛先、バックアップ添付の送信を設定",
    emailBack: "バックアップと保守に戻る",
    emailReload: "再読み込み",
    emailBackupDisabled: "自動バックアップは無効です。メール設定を保存し、自動バックアップを有効にすると送信が始まります。",
    emailDeliveryStatus: "送信状況",
    emailStatusDescription: "メール送信の結果と再試行を確認します。",
    emailSave: "メール設定を保存",
    emailConnection: "接続と認証",
    emailAddresses: "送信者と宛先",
    emailLimits: "送信制限とテスト",

    emailErrorConnection: "SMTP サーバーに接続できません。",
    emailErrorRejected: "SMTP サーバーが拒否しました。認証、宛先、サーバーの制限を確認してください。",
    emailErrorTimeout: "SMTP リクエストがタイムアウトしました。",
    emailErrorAttachment: "添付上限を超えました。ファイルはローカルに保持されます。",
    emailErrorFile: "バックアップファイルがないか、安全に読み取れません。",
    emailErrorExpired: "送信が期限切れか再試行上限に達しました。",
    emailErrorCredentials: "保存済みの SMTP 認証情報を読み取れません。",
    emailErrorInvalid: "メール設定が無効です。",

    emailTitle: "バックアップメール",
    emailEnabled: "メール送信を有効化",
    emailDescription: "バックアップを添付して送信します。通知とは独立した設定で、失敗した送信は自動再試行します。",
    email_host: "SMTP ホスト",
    email_username: "SMTP ユーザー名",
    emailSecurity: "接続の安全性",
    emailNoTls: "TLS なし",
    emailPort: "SMTP ポート",
    emailAuth: "認証方式",
    emailAuto: "自動",
    emailNoAuth: "認証なし",
    emailPassword: "SMTP パスワード",
    emailPasswordSaved: "保存済み・空欄で維持",
    emailClearPassword: "保存済みパスワードを削除",
    emailFrom: "送信元アドレス",
    emailName: "インスタンス / 送信者名",
    emailTo: "宛先（カンマ区切り）",
    emailTimeout: "タイムアウト（秒）",
    emailLimit: "添付上限（MiB）",
    emailTest: "テストメールを送信",
    emailTesting: "送信中…",
    emailTestSuccess: "テストメールを送信しました。添付を確認してください。",
    emailTestFailed: "テストに失敗しました。SMTP 設定、認証情報、宛先を確認してください。",
    emailLastAttempt: "最終送信試行",
    emailLastSuccess: "最終送信成功",
    emailPending: "送信待ちメール",
    emailNextRetry: "次回の再試行",
    emailDeliveryFailed: "送信失敗（ローカルバックアップは保持）",
    ...
    title: "メンテナンス",
    description:
      "Web ターミナルと Wake-on-LAN に保存されたパスワード、秘密鍵、鍵パスフレーズを含むシステムバックアップをエクスポートまたは復元します。",
    importWarning:
  ...
  certConfig: {
    ...
    downloadFailed: "証明書のダウンロードに失敗しました",
  ...
  subdomainProxy: {
    ...
    staticServe: {
      ...
      browser: {
        title: "サーバーパスを参照",
        open: "参照",
        hint: "ゲートウェイプロセスから見えるファイルとフォルダーを参照します。マッピングを保存するまで、選択したパスは公開されません。",
        dockerHint:
        ...
        loading: "サーバーパスを読み込み中…",
        retry: "再試行",
        empty: "このフォルダーに表示可能な項目はありません。",
        name: "名前",
        size: "サイズ",
        modified: "更新日時",
        previousPage: "前へ",
        nextPage: "次へ",
        openDirectoryAria: "フォルダー {name} を開く",
        selectFileAria: "ファイル {name} を選択",
        selectedPath: "使用するパス:",
        noSelection: "選択可能なパスがありません",
        cancel: "マッピング設定に戻る",
        useCurrentFolder: "現在のフォルダーを使用",
        useSelectedFile: "選択したファイルを使用",
        errors: {
          invalid_path: "指定されたパスは無効です。",
          invalid_cursor:
            "このページ位置は無効です。フォルダーを開き直してください。",
          protected_path: "この保護された場所は参照できません。",
          not_found: "指定されたパスは存在しなくなりました。",
          permission_denied: "FN-Knock はこの場所を読み取れません。",
          not_directory: "指定された場所はフォルダーではありません。",
          directory_too_large:
            "項目が多すぎるため、このフォルダーを安全に参照できません。",
          unsupported_type: "この場所の種類はサポートされていません。",
          unavailable: "この実行環境ではパス参照を利用できません。",
          browse_failed:
            "サーバーパスを参照できませんでした。再試行してください。",
          invalid_response: "ゲートウェイから無効なパス一覧が返されました。",
        },
      },
    ...
    batchEdit: {
      ...
      autoTitle: "自動タイトル",
      titleHint: "空欄にすると自動タイトルを使用します。他の設定は保持されます。",
      target: "転送先 URL",
      path: "ファイル / ディレクトリパス",
      save: "すべて保存",
      saving: "保存中…",
      retry: "関連設定を再試行",
      saved: "すべての変更を保存しました",
      invalidHost: "有効な完全ドメインを入力してください。",
      duplicateHost: "ドメインが重複しているか使用中です。既存ドメインの入れ替えはできません。",
      invalidTarget: "有効な HTTP、HTTPS、WS または WSS の転送先 URL を入力してください。",
      authTarget: "一括編集ではアプリのマッピングを認証サービスに変更できません。",
      invalidPath: "安全なサーバーの絶対パスを入力し、既存の静的配信設定を確認してください。",
      conflict: "設定が変更されました。入力内容を控え、一括編集を開き直してください。他の変更は上書きしません。",
      failed: "保存に失敗しました。再試行してください。",
      partial: "マッピングは保存されましたが、一部の関連設定を更新できませんでした。関連設定を再試行してください。",
      discardTitle: "一括編集を閉じますか？",
      discardDescription: "閉じると未保存の変更は破棄されます。",
      partialDiscard: "マッピングは保存済みですが、関連設定は未完了です。閉じても保存済みの変更は元に戻りません。後で個別編集から関連設定を確認してください。",
    ...
    mappingDialogTitle: "マッピング設定",
    mappingDialogDescription:
      "サブドメインマッピングの対象とアクセス方法を設定します。",
  ...
  webTerminal: {
    metrics: {
      ...
      disk: "ディスク /",
      uptime: "稼働時間",
      duration: "{days}日 {hours}時間 {minutes}分",
      loading: "取得中…",
      failed: "指標を取得できません",
      stale: "データが古くなっています",
      rootFilesystem: "/ のファイルシステム。ディスク全体の容量ではありません",
      reason: {
        warming_up: "次の CPU サンプルを待機中",
        unsupported_platform: "このシステムはこの指標に対応していません",
        missing_command: "必要なシステムコマンドがありません",
        permission_denied: "システムカウンターを読み取れません",
        invalid_output: "システム出力を解析できません",
        counter_reset: "CPU カウンターがリセットされました。再取得を待機中",
        estimated: "利用可能なシステムカウンターからの推定値",
        exec_rejected: "SSH サーバーが指標取得チャネルを拒否しました",
        timeout: "取得がタイムアウトしました",
        output_limit: "取得結果が上限を超えました",
        collection_failed: "システムデータを取得できません",
        session_inactive: "ターミナルセッションは実行されていません",
      },
    },
    title: "Web ターミナル",
    destroyDescription:
    ...
    sessionPhase: {
      ...
      authenticating: "認証中",
      openingChannel: "SSH チャネルを開いています",
      requestingPty: "端末 PTY を要求中",
      running: "実行中",
      closing: "終了処理中",
      closed: "終了済み",
      exited: "シェルが終了しました",
    ...
    noTargets: "SSH 接続先がありません",
    noTargetsDescription:
      "サーバーを追加し、ホスト指紋を確認して認証テストを行うと、ターミナルを開けます。",
    targetEditorDescription:
      "認証情報はローカルで暗号化されます。認証情報を送信する前に、サーバーのホスト指紋を明示的に信頼してください。",
    targetNamePlaceholder: "my nas",
    host: "ホスト",
    authentication: "認証",
    clearPassphrase: "秘密鍵のパスフレーズを削除",
    hostIdentity: "ホスト ID",
    confirmHostKey: "ホスト指紋を確認",
    trustAndTestHostKey: "確認して SSH をテスト",
    hostKeyTrusted: "ホスト指紋を信頼済み",
    connectionTested: "接続テスト済み",
    terminateSessionsOnSave:
      "接続設定の変更に必要な場合、実行中の {count} セッションを終了します。",
    terminateSessionsOnSaveUnknown:
      "実行中のすべてのセッションを終了して、この接続設定の変更を適用します。",
    activeSessionsAffected: "実行中のセッションに影響します",
    deleteTargetTitle: "SSH 接続先を削除しますか？",
    deleteTargetDescription:
      "保存した接続先と暗号化された認証情報を削除します。",
    deleteTargetActiveDescription:
      "この接続先を削除すると、実行中の {count} セッションも終了します。",
    targetDeleted: "SSH 接続先を削除しました",
    targetDeleteFailed: "SSH 接続先を削除できませんでした",
    forceDeleteTargetTitle: "セッションを終了して接続先を削除しますか？",
    forceDeleteTargetDescription:
      "SSH 接続先「{target}」には実行中のセッションがあります。2 回目の確認後、それらを終了してから接続先を削除します。",
    forceDeleteSessionCount: "実行中の {count} セッションを終了します。",
    ...
    takeControl: "操作を引き継ぐ",
    viewerDescription:
      "別のブラウザーがこのセッションを操作しています。出力を表示するか、操作を引き継げます。",
    runtimeRestarted:
      "ターミナルサービスが再起動したため、以前のセッションは終了しました。",
  ...
  wafLogs: {
    ...
    routeTypes: {
      ...
      favicon: "アイコン",
      staticFile: "静的ファイル",
      staticDirectory: "静的ディレクトリ",
      toolbarAsset: "ツールバーリソース",
      toolbarData: "ツールバーデータ",
  ...
  gatewayRequestLogs: {
    ipView: {
      ...
      individual: "リクエスト別",
      grouped: "IP 別",
      hint: "選択した日付と条件に一致する保存済みリクエストを IP ごとに集計します。",
      sortLabel: "並び順",
      requests: "リクエスト数",
      hosts: "サイト",
      responses: "レスポンス",
      ...
      back: "IP 一覧に戻る",
      unknown: "不明な送信元",
      showAll: "この IP の当日の全リクエストを表示",
      retry: "再試行",
      loading: "選択した日の全リクエストを集計中…",
      summary: "{date} · {ips} IP · {requests} リクエスト",
      filteredSummary:
        "{date} · 絞り込み結果：{ips} IP · {requests} リクエスト",
      detailCount: "現在の条件で {count} リクエスト",
      hostCount: "{count} サイト",
      ...
      sorts: {
        requests: "リクエスト数順",
        last_seen: "最新アクセス順",
        client_errors: "4xx 件数順",
        server_errors: "5xx 件数順",
        waf_hits: "WAF 検出数順",
      },
    },
    title: "リクエストログ",
    ...
    authDecisions: {
      ...
      public: "公開アクセス",
      ruleMissing: "ルールなし",
      bindingToken: "バインディングトークン",
      scopeDenied: "資格情報スコープで拒否",
      http1Required: "HTTP/1 が必要",
      http2Required: "HTTP/2 が必要",
      disabled: "Host が無効",
      outsideWindow: "利用時間外",
      scheduleClosed: "スケジュール外",
      advancedBypass: "高度なバイパスで許可",
      authUnconfigured: "認証が未設定",
      authError: "認証サービスエラー",
      timeout: "認証タイムアウト",
      queueFull: "認証キュー満杯",
      disconnected: "認証ブリッジ切断",
      bridgeUnavailable: "認証ブリッジ利用不可",
      invalidResponse: "無効な認証レスポンス",
      internal: "内部エラー",
    },
    grantStates: {
      issued: "発行済み",
  ...
  eventCenter: {
    ...
    eventTypes: {
      ...
      FN_EVENT_TERMINAL_AUDIT: "Web ターミナル監査",
    },
    groupBy: {
      GLOBAL: "グローバル",
      IP: "IP",
    ...
    runtime: {
      ...
      debug: {
        ...
        title: "Rust 実行診断",
        description:
          "プロセスのリソース、スレッド、バックグラウンドタスク、SQLite の動作を確認します。",
        unavailable:
          "実行診断を利用できません。フロントエンドとバックエンドのバージョンを確認してください。",
        loadFailed:
          "診断の取得に失敗しました。表示中のデータは古い可能性があります。再試行してください。",
        retry: "再試行",
        loading: "診断を読み込み中",
        cpus: "論理 CPU: {count}",
        updated: "レポート取得日時",
        ...
        start: "60 秒間の計測を開始",
        captureHint:
          "開始操作後に 1 秒ごと、最大 60 秒間計測します。ウィンドウを閉じても完了まで続きます。再計測すると前回の結果を置き換えます。",
        averageCpu: "平均 CPU",
        peakCpu: "最大 CPU",
        latestRss: "最新サンプルの RSS",
        rssChange: "計測中の RSS 変化",
        empty:
          "サンプルはありません。計測を開始してリソースと処理の動作を確認してください。",
        cpuHint:
          "論理コア 1 個のフル稼働を CPU 100% とします。最初のサンプルでは CPU を計算できません。異なるハードウェア間で単純比較はできません。",
        rssHint:
          "RSS が安定していてもリークは否定できません。長時間の稼働や操作の繰り返しと合わせて確認してください。",
        partial: "一部の指標を取得できません",
        sampleDetails: "秒ごとのサンプル",
        time: "時刻",
        queue: "待機数",
        memory: "メモリの内訳",
        refreshMemory: "メモリ詳細を取得",
        memoryHint:
          "必要に応じてメモリマッピング統計を取得します。メモリ解放は行いません。このスナップショットの取得時刻は計測とは別です。",
        memoryEmpty: "メモリ詳細は未取得です。",
        snapshotRss: "スナップショット RSS",
        anonymous: "匿名メモリ",
        file: "ファイルマッピング",
        swap: "スワップ",
        category: "分類",
        ...
        allocator: "アロケータ統計",
        allocatorHint:
          "アロケータの管理値です。割当量は生存オブジェクトの正確なサイズではなく、空き領域をすべて OS に返せるとは限りません。",
        allocated: "割当済み",
        free: "アロケータ空き領域",
        mapped: "直接マッピング",
        releasable: "解放候補領域",
        largestRegions: "大きな匿名領域",
        size: "仮想サイズ",
        threads: "スレッド CPU の上位",
        threadsHint:
          "各秒の CPU 上位 8 スレッドのサンプルから平均を推定し、上位 8 件を表示します。記録対象外の活動は含まれない場合があります。スレッド名は調査の手がかりです。",
        threadsEmpty:
          "スレッドのサンプルがないか、このシステムではスレッド CPU 統計を利用できません。",
        name: "スレッド名",
        operations: "バックグラウンドタスクとデータベース処理",
        wallHint:
          "計測期間中の診断対象処理を、各グループの合計経過時間上位 10 件で表示します。経過時間には待機が含まれ、CPU 時間とは異なります。非同期タスクごとの CPU は算出しません。",
        tasks: "バックグラウンドタスク",
        waits: "イベント待機（通常のアイドル時間を含む）",
        sqlite: "SQLite 処理",
        operation: "処理ラベル",
        calls: "回数",
        wall: "合計経過 ms",
        ...
        rows: "報告項目数",
        rowsHint:
          "項目数は処理が明示的に報告した業務上の件数であり、SQL の影響行数全体ではありません。未完了は現在または計測終了時点の状態です。",
        operationsEmpty: "計測中にこの種類の処理はまだ記録されていません。",
        dropped: "{count} 件の処理が統計上限を超えたため含まれていません。",
        queueDepth: "主 DB キュー: 現在 / 起動後最大",
        queueWait: "キュー待機: 直近 / 起動後最大",
        activeOperation: "現在の処理の経過時間",
        privacy:
          "エクスポートは診断ラベルと指標のみです。SQL、リクエスト内容、設定、認証情報は含みません。",
        copy: "JSON をコピー",
        export: "JSON を保存",
        copied: "実行診断をコピーしました",
        copyFailed: "コピーできませんでした。JSON の保存をご利用ください。",
        status: {
          idle: "未開始",
          running: "計測中",
          completed: "完了",
        ...
        categories: {
          heap: "メインヒープ",
          main_stack: "メインスレッドのスタック",
          anonymous_mappings: "匿名マッピング",
          file_or_special: "ファイル・システムマッピング",
        },
        memoryStatus: {
          available: "詳細取得済み",
          partial: "一部のみ取得",
          unsupported: "このシステムは詳細マッピング統計に非対応です",
          unavailable: "メモリ詳細を取得できません",
        },
      },
      memory: {
        open: "Go メモリを管理",
    ...
    events: {
      ...
      terminalAuditActions: {
        ...
        target_updated: "SSH ターゲットを更新",
        target_deleted: "SSH ターゲットを削除",
      ...
      detailFields: {
        ...
        session_id: "セッション ID",
        target_id: "SSH ターゲット ID",
        revision: "ターゲットのリビジョン",
        error_code: "エラーコード",
        ip: "IP アドレス",
        ip_location: "IP 地域",
  ...
  notifications: {
    ...
    body: {
      ...
      commonFacts: "共通の詳細",
      factVariablesHelp:
        "イベント別に詳細変数を挿入します。値は通知の表示と一致します。別のイベントの項目は存在しない場合があり、プレビューに表示されます。",
      mode: "Body モード",
      standard: "標準 Body",
      inherit: "Provider を継承",
      custom: "カスタム Body",
      format: "Body 形式",
      template: "Body テンプレート",
      formatJson: "JSON を整形",
      variables: "利用可能な変数",
      variablesHelp:
        "{'{{'}path{'}}'} で安全なパス変数を挿入します。JSON 文字列が 1 つの変数だけなら元の JSON 型を保持し、他の文字列に埋め込むとテキストになります。リテラルの {'{{'} は {'\\\\{{'} と記述します。欠落値はプレビューに表示されますが、送信は妨げません。",
      loadSample: "サンプル JSON を挿入",
      sampleContext: "サンプル Context",
      sampleHelp:
        "空欄ではサーバーのサンプルを使用します。JSON を入力するとプレビューとテストリクエストのみを上書きし、保存はされません。",
      preview: "プレビューを生成",
      previewing: "生成中…",
      testing: "送信中…",
      testSend: "テスト送信",
      missingVariables: "欠落している変数",
      previewFailed: "Webhook Body の生成に失敗しました",
      testFailed: "Webhook のテスト送信に失敗しました",
      testSuccess: "Webhook のテスト送信に成功しました",
      fixErrors: "Webhook Body の設定エラーを修正してください",
      errors: {
        invalidMode: "有効な Body モードを選択してください。",
        invalidFormat: "JSON またはテキスト形式を選択してください。",
        templateRequired: "Body テンプレートを入力してください。",
        templateTooLarge: "テンプレートは {max} バイト以内にしてください。",
        invalidJson: "JSON テンプレートが無効です: {detail}",
        unclosedVariable: "テンプレート変数の閉じ括弧がありません。",
        invalidVariable: "テンプレート変数 {detail} は使用できません。",
        tooManyVariables: "テンプレート変数は {max} 個以内にしてください。",
        invalidContentType: "有効な Content-Type MIME 値を入力してください。",
        contentTypeTooLong: "Content-Type は {max} バイト以内にしてください。",
        sampleTooLarge: "サンプル Context は {max} バイト以内にしてください。",
        invalidSample: "サンプル Context は JSON オブジェクトにしてください。",
      },
    },
    deliveries: {
