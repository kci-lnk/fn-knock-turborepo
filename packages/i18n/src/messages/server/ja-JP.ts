  ...
  notifications: {
    ...
    templates: {
      ...
      terminalActions: {
        ...
        sessionCreationStarted: "SSH セッションの作成を開始",
        sessionCreationFailed: "SSH セッションの作成に失敗",
        sessionEnded: "SSH セッションを終了",
        sessionExited: "リモート Shell が終了",
        sessionLost: "SSH セッションの接続が切断",
      },
      credential: "認証情報",
