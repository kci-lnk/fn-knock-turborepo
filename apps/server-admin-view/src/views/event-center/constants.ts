...
export const SYSTEM_EVENT_TYPE_OPTIONS: Array<{
  ...
  {
    value: "FN_EVENT_TERMINAL_AUDIT",
    labelKey: "admin.eventCenter.eventTypes.FN_EVENT_TERMINAL_AUDIT",
  },
  ...[
...
> = {
  ...
  FN_EVENT_TERMINAL_AUDIT: "SUBJECT",
  ...
  FN_EVENT_RUNTIME_STOP_FAILED: "SUBJECT",
